...
\newcommand{\email}{\hfill \textit{Email: }xcai.stonybrook@gmail.com\xspace}
...
\begin{ressection}{Education}
	...
	\begin{ressubsec_empty}{Stony Brook University}{Stony Brook, NY}{\textbf{Ph.D.} in Computer Science(GPA:3.93/4) \hfill \textbf{September 2007 -- August 2014}}	
...
\begin{ressection}{Working Experience}
	\begin{ressubsec_empty}{Twitter Inc.}{Cambridge, MA}{\textbf{Software Engineer II} \hfill \textbf{September 2014 -- present}}
		\vspace{-2pt}
		%\begin{small}
		%	\resitem{group name}
		%\end{small}
...
\begin{ressection}{Publications}
	\resitem{Fixing Races For Good: Portable and Reliable UNIX File-System Race Detection.
	\begin{small} \textbf{Xiang Cai}, Rucha Lale, Xincheng Zhang and Rob Johnson. \textit{10th ACM Symposium on Information, Computer and Communications Security, Singapore, April 2015}.
	\end{small}}
	...
	\resitem{Exploiting Unix File-System Races via Algorithmic
		Complexity Attacks. \begin{small} \textbf{Xiang Cai}, Yuwei Gui, and
			Rob Johnson. \textit{30th IEEE Symposium on Security and Privacy,
				Oakland, CA, May 2009}. %(Acceptance rate: 10.2\%, 26/254)
				\end{small}}
