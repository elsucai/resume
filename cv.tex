...
\begin{ressection}{Education}
	...
	\begin{ressubsec}{Stony Brook University}{Stony Brook, NY}{\textbf{Ph.D.} candidate
		in Computer Science(GPA:3.93/4): Expected May 2014}
		\ressubitem{Research focused on \textbf{Network Security} and \textbf{System Security}
		%	\begin{small}
		%		\textit{} 
		%	\end{small}
		}
...
%		}                                                                     
	...
	\begin{ressubsec_empty}{University of Sciences \& Technology of
		China(USTC)}{Hefei, Anhui, China}{\textbf{B.E.} in Computer
			Science(GPA:3.83/4.3): July 2007}
	\end{ressubsec_empty}
