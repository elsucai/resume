...
\begin{ressection}{Work Experience}
    \vspace{-5pt}
    \item
        {\fontfamily{serif}\selectfont\Large\bf{{Twitter}\hfill{Cambridge, MA}}}\vspace{3pt} \\
        {\emph{\textbf{Senior Software Engineer} (Learning Streams Platform Team)} \hfill\emph{October 2021 -- November 2022}}
    \vspace{-4pt}
    \begin{itemize}
        \begin{small}
            ...
            \resitem{Improved a data ingestion service that processes around 10 million events per second to ingest data in real time to Kafka.}
    		...
    		\resitem{Designed and implemented a self-serving data governance service that is essential for event ownership management, user privacy and traffic control. (Scala, MySQL.)}
    		\resitem{Contributed to the design and implementation of a real-time event ingestion pipeline that provides critical data to analytic systems and ML model training downstream. (Scala, Kafka, BigQuery, Pubsub, Terraform.)}
    	\end{small}
	\end{itemize}
	
    {\emph{\textbf{Senior Software Engineer} (Video Data Infrastructure Team)} \hfill\emph{December 2019 -- October 2021}} \\
    {\emph{\textbf{Software Engineer II} (Video Data Infrastructure Team)} \hfill\emph{April 2018 -- December 2019}}
    \vspace{-4pt}
    \begin{itemize}
        \begin{small}
            \resitem{Prototyped a metrics computation PoC using Airflow running on GCP. (Python)}
    		\resitem{Contributed to the design and implementation of moving the media event aggregation infrastructure from on-prem to GCP. (Dataflow, BigQuery, BigTable, Pubsub.)}
    		\resitem{Oversaw the Personal Data Protection work on the VDI team and made sure the 10+ services and datasets we own are compliant with global regulation laws. (GDPR, etc.)}
    	\end{small}
	\end{itemize}
	
	{\emph{\textbf{Tech Lead, Software Engineer II} (Media Monetization Team)} \hfill\emph{March 2017 -- April 2018}} \\
    {\emph{\textbf{Software Engineer II} (Media Monetization Team)} \hfill\emph{September 2014 -- March 2017}}
    \vspace{-4pt}
    \begin{itemize}
        \begin{small}
    		\resitem{Built, maintained and improved services that were responsible for computing and serving various video metrics, including the video view counts shown on Twitter videos. (Scala, Scalding.)}
    		\resitem{Designed and implemented a data validation system that monitored video event quality. (Python, Presto.)}
    	\end{small}
	\end{itemize}
	
	\vspace{-5pt}
    \item
        {\fontfamily{serif}\selectfont\Large\bf{{Hewlett-Packard Labs}\hfill{Princeton, NJ}}}\vspace{3pt} \\
        {\emph{Research Associate Intern} \hfill\emph{June 2012 -- August 2012}}
    \vspace{-4pt}
    \begin{itemize}
        \begin{small}
...
\begin{ressection}{Education}
    \vspace{-5pt}
    \item
        {\fontfamily{serif}\selectfont\Large\bf{{Stony Brook University}\hfill{Stony Brook, NY}}}\vspace{3pt} \\
        {\emph{\textbf{Ph.D.} in Computer Science (GPA:3.93/4)} \hfill\emph{September 2007 -- August 2014}}
    \vspace{-4pt}
    \begin{itemize}
        \begin{small}
            \resitem{Research focuses on \textbf{System Security, Network Security} and \textbf{Privacy.}}
    	\end{small}
	\end{itemize}
...
%	\end{ressubsec}
    ...
    \vspace{-5pt}
    \item
        {\fontfamily{serif}\selectfont\Large\bf{{University of Sciences \& Technology of China}\hfill{Hefei, Anhui, China}}}\vspace{3pt} \\
        {\emph{\textbf{B.E.} in Computer Science (GPA:3.83/4.3)} \hfill\emph{September 2003 - July 2007}}
