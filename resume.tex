...
\newcommand{\addrlineb}{\textbf{Address: }Arlington, MA, 02476, USA\xspace}
\newcommand{\linkedin}{\textbf{LinkedIn: }\href{https://www.linkedin.com/in/xiang-cai-2906924b/}{Xiang Cai}\xspace}
...
\begin{ressection}{Work Experience}
    ...
    \end{flushleft}
    \vspace{-16pt}
    \item {\emph{\textbf{Senior Software Engineer}} \hfill\emph{December 2019 -- November 2022}}
    \vspace{-4pt}
    \begin{itemize}
        \begin{small}
            \resitem{Worked on several backend teams focusing on data processing and metrics computing.}
            \resitem{Acted as the functional Tech Lead for a team of four engineers.}
            \resitem{Oversaw a multi-team effort to integrate critical server side metadata into event logs. The project helped improve the team velocity and provided better quality user signals to serve more relevant content to end users and ultimately improved our app engagement by 0.1\%.}
            ...
            \resitem{Presented the improved data ingestion pipeline to org leadership during all-hands meetings.}
	...
	\item {\emph{\textbf{Tech Lead, Software Engineer II}} \hfill\emph{September 2014 -- December 2019}}
    \vspace{-4pt}
    \begin{itemize}
        \begin{small}
            \resitem{Oversaw the Personal Data Protection work on the Video Data Infrastructure team and made sure the 10+ services and datasets we own were compliant with global regulation laws. (GDPR, etc.)}
...
\textbf{Background:} & Distributed System, Big Data Analysis, Data Pipeline, Security and Privacy \\
\end{tabular}
\end{table}
\vspace{-8pt}
