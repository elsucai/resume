...
\newcommand{\email}{\textit{Email: }xcai.stonybrook@gmail.com}
...
\begin{ressection}{Education}
	...
	\begin{ressubsec}{Stony Brook University}{Stony Brook, NY}{\textbf{Ph.D.} candidate
		in Computer Science(GPA:3.93/4): Sep. 2007- Present}
		\ressubitem{Research was focused on Network Security and System Security
		%	\begin{small}
		%		\textit{} 
		%	\end{small}
		}
...
%		}                                                                     
	...
	\begin{ressubsec_empty}{University of Sciences \& Technology of
		China(USTC)}{Hefei, Anhui, China}{\textbf{B.E.} in Computer
			Science(GPA:3.83/4.3): Sep. 2003 - July. 2007}
	\end{ressubsec_empty}
...
\begin{ressection}{Research Projects}
	...
	\resitem{\textbf{Websites fingerprinting attacks on Tor. May.
		...
		Proposed and implemented two new website fingerprinting
			...
			recently-published fingerprinting attacks on Tor. \textbf{Source code can be found at git@github.com:xiang-cai/fingerprinting\_attack\_code.git}
		\end{small}				
	}
	...
	\resitem{\textbf{A C library for serializable file-system
		...
		Proposed and implemented an
					...
					benchmark. \textbf{Source code can be found at git@github.com:xiang-cai/trace.git}
		\end{small}
	}
	...
	\resitem{\textbf{Race attack on Unix File-Systems. Oct. 2008. [C/Shell]}
		...
		Defeated two proposed Unix file-system race
			...
			protection. \textbf{Source code can be found at git@github.com:xiang-cai/race\_attack.git}
		\end{small}
	} 
...
\begin{ressection}{Selected Course Projects}
	...
	\resitem{\textbf{Very Simple Real File-System, Dec. 2008. [C/Kernel Programming]} 
		\begin{small}
		Implemented a very simple file-system with a group of 3 people, which supported regular file operations such as create, open, close, lookup, link, delete, etc.
		\end{small}
	}
